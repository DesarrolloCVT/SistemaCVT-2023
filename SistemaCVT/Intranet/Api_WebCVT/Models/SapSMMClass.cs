...
namespace Api_WebCVT.Models
{
    public class SapSMMClass
    {
        #region Conect SAPSMM
        ...
        DBMLSapSMMDataContext DBSapSMM = new DBMLSapSMMDataContext();
        ...
        string SAPCompany = "ZBO_MMETRO"; ////// Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["SMMCompany"]);// 
        ...
        public int ObtieneCantDirecciones()
        {
            ...
            try
            {
                ret = (from t in DBSapSMM.MMETRO_CRD1
