<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="RPTFefo.aspx.cs" Inherits="CVT_MermasRecepcion.Reporteria.RPTFefo" %>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxComboBox ID="cbo_bodega" runat="server" DataSourceID="LqDsBodega"
                        ValueField="Site_ShortDescription" Width="200px">
                        <Columns>
