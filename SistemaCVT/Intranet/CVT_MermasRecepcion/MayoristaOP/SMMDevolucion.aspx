<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="SMMDevolucion.aspx.cs" Inherits="CVT_MermasRecepcion.MayoristaOP.SMMDevolucion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
       <%-- <div id="breadcrumbs">
        <ul>
            ...
            <li><a>WMS</a></li>
            <li><span id="current">SMM Devolucion</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">SMM Devolucion</span>
    ...
    <br />
     <div>
        <dx:ASPxGridView ID="GvDatos" runat="server" AutoGenerateColumns="False"
            ...
            OnHtmlRowCreated="GvDatos_HtmlRowCreated" OnToolbarItemClick="GvDatos_ToolbarItemClick" OnCommandButtonInitialize="GvDatos_CommandButtonInitialize" OnRowUpdated="GvDatos_RowUpdated">
	...
	if (e.item.name == &quot;Nuevo&quot;) e.processOnServer = true; e.usePostBack=true;
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Reception_Id" ReadOnly="True"
                    ShowInCustomizationForm="True" VisibleIndex="1" Caption="Folio">
                ...
                <dx:GridViewDataComboBoxColumn Caption="T Recepcion" FieldName="Reception_Type"
                    ...
                    <PropertiesComboBox>
                        <Items>
                            <dx:ListEditItem Text="DEVOLUCION" Value="4" />
                        </Items>
                    </PropertiesComboBox>
                </dx:GridViewDataComboBoxColumn>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="TipoDocSAP" VisibleIndex="12">
                    <PropertiesComboBox>
                        <Items>
                            <dx:ListEditItem Text="Devolucion" Value="16" />
                        </Items>
                    </PropertiesComboBox>
                </dx:GridViewDataComboBoxColumn>
            </Columns>
        ...
        <asp:LinqDataSource ID="LqDsRecepciones" runat="server"
            ...
            Where="Reception_DateIn &gt;= @Reception_DateIn &amp;&amp; Reception_DateIn &lt;= @Reception_DateIn1 &amp;&amp; TipoDocSAP == @TipoDocSAP"
            EnableUpdate="True">
            <WhereParameters>
                ...
                <asp:ControlParameter ControlID="dteTermino" Name="Reception_DateIn1"
                    PropertyName="Value" Type="DateTime" DefaultValue="01-01-1990" />
                <asp:Parameter DefaultValue="16" Name="TipoDocSAP" Type="Int32" />
            </WhereParameters>
        </asp:LinqDataSource>
        <asp:LinqDataSource ID="LqDsSite" runat="server"
            ContextTypeName="DBMermasRecepcion.DBMLCVTWMSMETRODataContext" EntityTypeName=""
            TableName="SMM_Site" Where="Site_Id == @Site_Id">
            <WhereParameters>
                <asp:Parameter DefaultValue="2" Name="Site_Id" Type="Int32" />
            </WhereParameters>
        </asp:LinqDataSource>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <dx:ASPxComboBox ID="cboTipoRecepcion" runat="server" ValueType="System.String" Height="30px" >
                                        <Items>
                                            <dx:ListEditItem Text="DEVOLUCION" Value="4" />                                          
                                        </Items>
                                        <ValidationSettings Display="Dynamic">
    ...
    <dx:EntityServerModeDataSource ID="gvd" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTMMETRODataContext" />
    <dx:LinqServerModeDataSource ID="lqs1" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" />
