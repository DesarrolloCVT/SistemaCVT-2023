<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="SMMRecepcion.aspx.cs" Inherits="CVT_MermasRecepcion.MayoristaOP.SMMRecepcion" %>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
        ...
        <asp:LinqDataSource ID="LqDsProveedor" runat="server"
            ...
            TableName="MMetro_OCRD" Where="validFor == @validFor">
            <WhereParameters>
            ...
            <ContentCollection>
                <dx:PopupControlContentControl runat="server">
                    ...
                    <asp:LinqDataSource ID="lqsProveedor2" runat="server"
                        ContextTypeName="DBMermasRecepcion.DBMLCVTMMETRODataContext" EntityTypeName=""
                        TableName="MMetro_OCRD" Where="CardType == @CardType &amp;&amp; validFor == @validFor">
                        <WhereParameters>
