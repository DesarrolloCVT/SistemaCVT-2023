<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Personal.aspx.cs" Inherits="CVT_MermasRecepcion.Calidad.Personal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Calidad</a></li>
            <li><span id="current">Personal</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Personal</span>
  ...
  <%--      <div id="options">
    ...
    <div>
        ...
        <dx:ASPxGridView ID="GvDatos" runat="server" AutoGenerateColumns="False"
            DataSourceID="LqDsControlHigene" KeyFieldName="Id_Personal" OnToolbarItemClick="GvDatos_ToolbarItemClick" OnRowDeleting="GvDatos_RowDeleting" OnRowInserting="GvDatos_RowInserting" OnRowUpdating="GvDatos_RowUpdating">
