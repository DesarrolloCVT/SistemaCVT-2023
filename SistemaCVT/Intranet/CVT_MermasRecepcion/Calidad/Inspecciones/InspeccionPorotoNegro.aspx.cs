...
{
    public partial class InspeccionPorotoNegro : System.Web.UI.Page
    {
        ...
        protected void GvDatos_RowCommand(object sender, DevExpress.Web.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            {
                Session["Id_IspeccionPT_PorotoNegro"] = e.KeyValue;
                Response.Redirect("~/Calidad/Inspecciones/InspeccionPorotoNegroDetalle.aspx");
            }
            if (e.CommandArgs.CommandName == "cmdDetallePdf")
            {
                int id = Convert.ToInt32(e.KeyValue);
                ReportDocument Info = new ReportDocument();
                Info.Load(Server.MapPath("~/R.HACCP.11.rpt"));
        ...
        protected void btnVerificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool res = Cal.ActualizaEstadoInspeccionPorotoNegro(idIsn, "Verificado", idUser);

                if (res == true)
                {

                    LogClass vLog = new LogClass();
                    vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 151, "Verifica Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 151, "Elimina Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 151, "Actualiza Registro");
