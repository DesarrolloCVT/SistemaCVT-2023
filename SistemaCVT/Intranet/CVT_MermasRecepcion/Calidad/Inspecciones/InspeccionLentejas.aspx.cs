...
{
    public partial class InspeccionLentejas : System.Web.UI.Page
    {
        ...
        protected void GvDatos_RowCommand(object sender, DevExpress.Web.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            {
                Session["Id_InspeccionPT_Lenteja"] = e.KeyValue;
                Response.Redirect("~/Calidad/Inspecciones/InspeccionLentejaDetalle.aspx");
            }
            if (e.CommandArgs.CommandName == "cmdDetallePdf")
            {
                int id = Convert.ToInt32(e.KeyValue);
                ReportDocument Info = new ReportDocument();
                Info.Load(Server.MapPath("~/R.HACCP.06.rpt"));
        ...
        protected void GvDatos_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 142, "Crea Registro");
        ...
        protected void btnVerificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool res = Cal.ActualizaEstadoInspeccionLenteja(idIsn, "Verificado", idUser);

                if (res == true)
                {
                    LogClass vLog = new LogClass();
                    vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 142, "Verifica Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 142, "Elimina Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 142, "Actualiza Registro");
