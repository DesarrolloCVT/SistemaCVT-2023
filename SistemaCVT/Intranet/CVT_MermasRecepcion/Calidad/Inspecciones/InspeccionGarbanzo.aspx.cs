...
{
    public partial class InspeccionGarbanzo : System.Web.UI.Page
    {
        ...
        protected void GvDatos_RowCommand(object sender, DevExpress.Web.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            {
                Session["Id_InspeccionPT_Garbanzo"] = e.KeyValue;
                Response.Redirect("~/Calidad/Inspecciones/InspeccionGarbanzoDetalle.aspx");
            }
            if (e.CommandArgs.CommandName == "cmdDetallePdf")
            {
                int id = Convert.ToInt32(e.KeyValue);
                ReportDocument Info = new ReportDocument();
                Info.Load(Server.MapPath("~/R.HACCP.10.rpt"));
        ...
        protected void btnVerificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool res = Cal.ActualizaEstadoInspeccionGarbanzo(idIsn, "Verificado", idUser);

                if (res == true)
                {
                    LogClass vLog = new LogClass();
                    vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 141, "Crea Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 141, "Elimina Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 141, "Actualiza Registro");
