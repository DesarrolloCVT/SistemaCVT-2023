<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="InspeccionGarbanzo.aspx.cs" Inherits="CVT_MermasRecepcion.Calidad.Inspecciones.InspeccionGarbanzo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Calidad</a></li>
            <li><span id="current">Inspeccion Garbanzo</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Inspeccion Garbanzo</span>
...
<Image Url="../../Images/pn-add-source-copy.gif"></Image>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Id_InspeccionPT_Garbanzo" ReadOnly="True" VisibleIndex="1" Visible="False">
                ...
                <dx:GridViewDataComboBoxColumn Caption="Proveedor" FieldName="CardCode" VisibleIndex="3">
                    <PropertiesComboBox DataSourceID="LqsProveedor" TextField="CardName" ValueField="CardCode">
                    </PropertiesComboBox>
                </dx:GridViewDataComboBoxColumn>
                <dx:GridViewDataComboBoxColumn Caption="Encargado" FieldName="IdUsuario" VisibleIndex="5">
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
        ...
        <asp:LinqDataSource ID="LqsGarbanzo" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="CVT_InspeccionPT_Garbanzo" OrderBy="Id_InspeccionPT_Garbanzo desc">
        </asp:LinqDataSource>
        ...
        <asp:LinqDataSource ID="LqsProducto" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" TableName="CVT_VW_ProductoGarbanzo">
        </asp:LinqDataSource>
    </div>
    <div>
