<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RegistroSaturacionPatrones.aspx.cs" Inherits="CVT_MermasRecepcion.Calidad.Inspecciones.RegistroSaturacionPatrones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Calidad</a></li>
            <li><span id="current">Registro Saturacion Patrones</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Registro Saturacion Patrones</span>
    ...
    <div>
        <dx:ASPxGridView ID="GvDatos" runat="server" AutoGenerateColumns="False" DataSourceID="LqsSaturacionPatrones" KeyFieldName="Id_SaturacionPatrones" OnToolbarItemClick="GvDatos_ToolbarItemClick" OnRowDeleting="GvDatos_RowDeleting" OnRowUpdated="GvDatos_RowUpdated" OnRowUpdating="GvDatos_RowUpdating">
...
<Image Url="../../Images/pn-add-source-copy.gif"></Image>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Id_SaturacionPatrones" ReadOnly="True" Visible="False" VisibleIndex="1">
                    <EditFormSettings Visible="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn FieldName="FechaRegistro" VisibleIndex="3">
                </dx:GridViewDataDateColumn>
                <dx:GridViewDataTextColumn Caption="Cant.Veces Pasadas" FieldName="PasadasSeguidas" VisibleIndex="6">
                ...
                <dx:GridViewDataComboBoxColumn Caption="Detecta FE 2.5mm " FieldName="FE25mm" VisibleIndex="7">
                    <PropertiesComboBox>
                        <Items>
                            <dx:ListEditItem Text="SI" Value="1" />
                            <dx:ListEditItem Text="NO" Value="2" />
                ...
                <dx:GridViewDataComboBoxColumn Caption="Detecta NO FE3.0mm " FieldName="NOFE30mm" VisibleIndex="8">
                    <PropertiesComboBox>
                        <Items>
                            <dx:ListEditItem Text="SI" Value="1" />
                            <dx:ListEditItem Text="NO" Value="2" />
                ...
                <dx:GridViewDataComboBoxColumn Caption="Detecta Acero Inoxidable 2.5mm " FieldName="Acero25mm" VisibleIndex="9">
                    <PropertiesComboBox>
                        <Items>
                            <dx:ListEditItem Text="SI" Value="1" />
                            <dx:ListEditItem Text="NO" Value="2" />
                ...
                <dx:GridViewDataComboBoxColumn FieldName="EnciendeBaliza" VisibleIndex="10">
                    <PropertiesComboBox>
                        <Items>
                            <dx:ListEditItem Text="SI" Value="1" />
                            <dx:ListEditItem Text="NO" Value="2" />
                ...
                <dx:GridViewDataComboBoxColumn Caption="Funciona brazo de rechazo" FieldName="BrazoRechazo" VisibleIndex="12">
                    <PropertiesComboBox>
                        <Items>
                            <dx:ListEditItem Text="SI" Value="1" />
                            <dx:ListEditItem Text="NO" Value="2" />
                ...
                <dx:GridViewDataTextColumn FieldName="Observaciones" VisibleIndex="14">
                </dx:GridViewDataTextColumn>
            </Columns>
        </dx:ASPxGridView>
        <asp:LinqDataSource ID="LqsSaturacionPatrones" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="CVT_RegistroSaturacionPatrones" Where="FechaRegistro == @FechaRegistro">
            <WhereParameters>
    ...
    <br />
    <div>
        <dx:ASPxPopupControl ID="popSaturacionPatrones" runat="server" Width="500px" AllowDragging="True" CloseAction="CloseButton" HeaderText="Nuevo" Modal="True" PopupAction="None" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="Middle">
            <ContentCollection>
                <dx:PopupControlContentControl>
                        ...
                        <table>
                            <tr>
                                <td class="auto-style6">
                                    <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Detecta FE 2.5mm" Font-Size="Medium" Font-Bold="true"></dx:ASPxLabel>
                                    <dx:ASPxComboBox ID="cboFE25mm" runat="server" ValueType="System.String" SelectedIndex="0" Width="50px">
                                        <Items>
                                ...
                                <td class="auto-style8">
                                    <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Detecta NO FE3.0mm " Font-Size="Medium" Font-Bold="true"></dx:ASPxLabel>
                                    <dx:ASPxComboBox ID="cboNOFE30mm" runat="server" ValueType="System.String" SelectedIndex="0" Width="50px">
                                        <Items>
                                            <dx:ListEditItem Selected="True" Text="SI" Value="1" />
                                            <dx:ListEditItem Text="NO" Value="2" />
                                        </Items>
                    ...
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Observaciones" Font-Size="Medium" Font-Bold="true"></dx:ASPxLabel>
                    ...
                    <br />
                    <div>
                        <dx:ASPxButton ID="btnAgregar" runat="server" Text="Guardar" OnClick="btnAgregar_Click" Theme="iOS" ValidationGroup="a1"></dx:ASPxButton>
                    </div>
