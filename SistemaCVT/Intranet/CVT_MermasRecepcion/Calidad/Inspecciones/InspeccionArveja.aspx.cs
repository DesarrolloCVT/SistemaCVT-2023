...
{
    public partial class InspeccionArveja : System.Web.UI.Page
    {
        ...
        protected void GvDatos_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 139, "Crea Registro");
        ...
        protected void GvDatos_RowCommand(object sender, DevExpress.Web.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            {
                Session["Id_InspeccionPT_Arveja"] = e.KeyValue;
                Response.Redirect("~/Calidad/Inspecciones/InspeccionArvejaDetalle.aspx");
            }
            if (e.CommandArgs.CommandName == "cmdDetallePdf")
            {
                int id = Convert.ToInt32(e.KeyValue);
                ReportDocument Info = new ReportDocument();
                Info.Load(Server.MapPath("~/R.HACCP.09.rpt"));
        ...
        protected void btnVerificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool res = Cal.ActualizaEstadoInspeccionArveja(idIsn, "Verificado", idUser);

                if (res == true)
                {
                    LogClass vLog = new LogClass();
                    vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 139, "Verifica Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 139, "Elimina Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 139, "Actualiza Registro");
