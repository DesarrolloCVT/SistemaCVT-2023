...
{
    public partial class InspeccionAzucar : System.Web.UI.Page
    {
        ...
        protected void GvDatos_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 140, "Crea Registro");
        ...
        protected void GvDatos_RowCommand(object sender, DevExpress.Web.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            {
                Session["Id_InspeccionPT_Azucar"] = e.KeyValue;
                Response.Redirect("~/Calidad/Inspecciones/InspeccionAzucarDetalle.aspx");
            }
            if (e.CommandArgs.CommandName == "cmdDetallePdf")
            {
                int id = Convert.ToInt32(e.KeyValue);
                ReportDocument Info = new ReportDocument();
                Info.Load(Server.MapPath("~/R.HACCP.05.rpt"));
        ...
        protected void btnVerificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool res = Cal.ActualizaEstadoInspeccionAzucar(idIsn, "Verificado", idUser);
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 140, "Elimina Registro");
        ...
        {
            LogClass vLog = new LogClass();
            vLog.LOGUsabilidad(Convert.ToInt32(Session["IDCVTUsuario"]), 140, "Actualiza Registro");
