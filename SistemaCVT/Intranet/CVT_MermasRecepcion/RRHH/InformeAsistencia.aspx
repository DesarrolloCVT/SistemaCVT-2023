<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="InformeAsistencia.aspx.cs" Inherits="CVT_MermasRecepcion.RRHH.InformeAsistencia" %>
...
<Image IconID="actions_download_16x16office2013"></Image>
        ...
        <Columns>
            ...
            <dx:GridViewDataDateColumn Caption="Fecha Asistencia" FieldName="Fecha" VisibleIndex="6">
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn Caption="Fecha Registro" FieldName="Fecha_Registro" VisibleIndex="14">
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataTextColumn FieldName="Comentario" VisibleIndex="15">
            </dx:GridViewDataTextColumn>
...
<dx:ListBoxColumn FieldName="pin" Caption="Run"></dx:ListBoxColumn>
            ...
            <dx:GridViewDataComboBoxColumn Caption="Responsable" FieldName="Id_Usuario" VisibleIndex="13">
            ...
            <dx:GridViewDataTextColumn FieldName="TotalMinTrabajados" ShowInCustomizationForm="True" VisibleIndex="10">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TotalHorasTrabajadas" ShowInCustomizationForm="True" VisibleIndex="11">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TotalPagoxHoras" ShowInCustomizationForm="True" VisibleIndex="12">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataComboBoxColumn FieldName="Turno" ShowInCustomizationForm="True" VisibleIndex="5">
                <PropertiesComboBox>
                    <Items>
