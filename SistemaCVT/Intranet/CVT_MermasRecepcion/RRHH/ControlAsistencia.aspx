<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ControlAsistencia.aspx.cs" Inherits="CVT_MermasRecepcion.RRHH.ControlAsistencia" %>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="TotalPagoxHoras" VisibleIndex="16">
                    <EditFormSettings Visible="False" />
                </dx:GridViewDataTextColumn>
        ...
        <asp:LinqDataSource ID="LqDsTrabajos0" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" Select="new (Nombre, Id_Labores)" TableName="CVT_LaboresExternas" Where="id_Area == @id_Area &amp;&amp; id_Area == @id_Area1">
            <WhereParameters>
                <asp:ControlParameter ControlID="cb_area" DefaultValue="0" Name="id_Area" PropertyName="Value" Type="Int32" />
                <asp:ControlParameter ControlID="cb_area" DefaultValue="0" Name="id_Area1" PropertyName="Value" Type="Int32" />
            </WhereParameters>
        </asp:LinqDataSource>
        <br />
    </div>
