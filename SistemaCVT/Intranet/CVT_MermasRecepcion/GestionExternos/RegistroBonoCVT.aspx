<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="RegistroBonoCVT.aspx.cs" Inherits="CVT_MermasRecepcion.GestionExternos.RegistroBonoCVT" %>
...
<div>
    <dx:ASPxGridView ID="GvBonoCVT" runat="server" AutoGenerateColumns="False" DataSourceID="LqDsBonoCVT" KeyFieldName="ID"  OnToolbarItemClick="GvBonoCVT_ToolbarItemClick" OnRowInserting="GvBonoCVT_RowInserting">
...
<Image IconID="actions_download_16x16office2013"></Image>
    ...
    <asp:LinqDataSource ID="LqDsBonoCVT" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" OrderBy="Fecha desc" TableName="CVT_GestionExternosBono" EnableDelete="True" EnableInsert="True" EnableUpdate="True">
    </asp:LinqDataSource>
