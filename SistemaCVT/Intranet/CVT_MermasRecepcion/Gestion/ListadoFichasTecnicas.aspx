<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ListadoFichasTecnicas.aspx.cs" Inherits="CVT_MermasRecepcion.Gestion.ListadoFichasTecnicas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Gestion</a></li>
            <li><span id="current">Fichas Tecnicas</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Fichas Tecnicas</span>
