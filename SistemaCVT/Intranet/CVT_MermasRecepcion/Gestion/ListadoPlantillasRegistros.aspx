<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ListadoPlantillasRegistros.aspx.cs" Inherits="CVT_MermasRecepcion.Gestion.ListadoPlantillasRegistros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    ...
    <ul>
        ...
        <li><a>Gestion</a></li>
        <li><span id="current">Plantillas de Registro</span></li>
    </ul>
</div>

<div id="tableHeader">
    <span class="tableTitle">Plantillas de Registro</span>
