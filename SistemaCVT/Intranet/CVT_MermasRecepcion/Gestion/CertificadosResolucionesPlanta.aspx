<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="CertificadosResolucionesPlanta.aspx.cs" Inherits="CVT_MermasRecepcion.Gestion.CertificadosResolucionesPlanta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Gestion</a></li>
            <li><span id="current">Certificado Resoluciones Planta</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Certificado Resoluciones Planta</span>
