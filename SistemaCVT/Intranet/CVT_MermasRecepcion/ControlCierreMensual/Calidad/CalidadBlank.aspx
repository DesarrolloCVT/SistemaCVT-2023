<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="CalidadBlank.aspx.cs" Inherits="CVT_MermasRecepcion.ControlCierreMensual.Calidad.CalidadBlank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
 ...
 <div id="mainContent">
            ...
            <h1>Puntos control para cierre de mes area Calidad,<a href="#">
 <asp:Label ID="lblUser" runat="server"></asp:Label></a></h1>
            ...
            <div id="launcher">
                <ul>
                    <li>
                        <h2 class="shortcut control-launcher">Calidad</h2>
                        <h3><a href="Hallazgos.aspx">Informe Registro Imanes</a></h3>
                        <p>Tendencia Imanes</p>
                    </li>
                   ...
                   <%-- <li>
                      ...
                      <li>
                        <h2 class="shortcut almacenamiento-launcher">Calidad</h2>
                        <h3><a href="ListarProyeccionPagos.aspx">Proyeccion de pagos</a></h3>
                        <p>Proyeccion de pagos</p>
                    </li>
                
                      <li>
                        <h2 class="shortcut camiones-launcher">Calidad</h2>
