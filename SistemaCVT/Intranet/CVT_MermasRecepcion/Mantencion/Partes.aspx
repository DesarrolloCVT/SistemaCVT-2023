<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Partes.aspx.cs" Inherits="CVT_MermasRecepcion.Mantencion.Partes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Maquinas</a></li>
            <li><span id="current">Partes</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Partes</span>
...
<Image IconID="actions_download_16x16office2013"></Image>
        ...
        <asp:LinqDataSource ID="LqDsArticulos" runat="server"
            ...
            EnableDelete="True">
            <WhereParameters>
                <asp:SessionParameter DefaultValue="1" Name="Padre_ID" SessionField="Padre_ID" Type="Int32" />
            </WhereParameters>
        </asp:LinqDataSource>
