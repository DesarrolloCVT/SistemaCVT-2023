<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="SMMEstadisticaComisiones.aspx.cs" Inherits="CVT_MermasRecepcion.Mayorista.SMMEstadisticaComisiones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
      <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Mayorista</a></li>
            <li><span id="current">SMM Estadisticas Comisiones</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">SMM Estadisticas Comisiones</span>
