<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ListadoPrecioDistrubucionDiventi.aspx.cs" Inherits="CVT_MermasRecepcion.Mayorista.ListadoPrecioDistrubucionDiventi" %>
    ...
    <div>
        <dx:ASPxGridView ID="GvDatos" runat="server" AutoGenerateColumns="False" DataSourceID="LqsListadoPrecioDistribucion" OnToolbarItemClick="GvDatos_ToolbarItemClick">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="CostoPromedio" VisibleIndex="5" Visible="False">
                    <PropertiesTextEdit DisplayFormatString="N2">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="UltimoPrecioCompra" VisibleIndex="6" Visible="False">
                    <PropertiesTextEdit DisplayFormatString="N2">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
            </Columns>
