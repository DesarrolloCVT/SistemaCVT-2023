<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="EstadisticasVentas2.aspx.cs" Inherits="CVT_MermasRecepcion.Mayorista.EstadisticasVentas2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    ...
    <br />
    <div>
            <dx:ASPxPivotGrid ID="PvDatos" runat="server" ClientIDMode="AutoID" IsMaterialDesign="False">
                <Fields>
                    ...
                    <dx:PivotGridField ID="fieldFechaContab" Area="RowArea" AreaIndex="2" FieldName="Fecha_Contab" Name="fieldFechaContab" Visible="False">
                    </dx:PivotGridField>
                    ...
                    <dx:PivotGridField ID="fieldRazonSocial" FieldName="Razon_Social" Name="fieldRazonSocial" AreaIndex="1">
                    </dx:PivotGridField>
                    ...
                    <dx:PivotGridField ID="fieldDescripcion" Area="RowArea" AreaIndex="1" FieldName="Descripcion" Name="fieldDescripcion">
                    </dx:PivotGridField>
...
<CellFormat FormatString="N0" FormatType="Custom"></CellFormat>
                    ...
                    <dx:PivotGridField ID="fieldPrecUnitario" Area="DataArea" AreaIndex="1" FieldName="Prec_Unitario" Name="fieldPrecUnitario" CellFormat-FormatString="N0" CellFormat-FormatType="Custom" Visible="False">
<CellFormat FormatString="N0" FormatType="Custom"></CellFormat>
                    </dx:PivotGridField>
                    <dx:PivotGridField ID="fieldTotalLinea" Area="DataArea" AreaIndex="1" FieldName="Total_Linea" Name="fieldTotalLinea" CellFormat-FormatString="N0" CellFormat-FormatType="Custom">
<CellFormat FormatString="N0" FormatType="Custom"></CellFormat>
                    </dx:PivotGridField>
