...
namespace CVT_MermasRecepcion {
    ...
    public class RHACCP120101 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CVT_MermasRecepcion.R.HACCP.12.01.01.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRHACCP120101 : Component, ICachedReport {
        
        public CachedRHACCP120101() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RHACCP120101 rpt = new RHACCP120101();
            rpt.Site = this.Site;
            return rpt;
        }
