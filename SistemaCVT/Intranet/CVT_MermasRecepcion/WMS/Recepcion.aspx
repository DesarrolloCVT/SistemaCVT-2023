<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Recepcion.aspx.cs" Inherits="CVT_MermasRecepcion.WMS.Recepcion" %>
...
<Image Url="../Images/pn-add-source-copy.gif"></Image>
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="AccessControl_Id"
                                ShowInCustomizationForm="True" VisibleIndex="29" Caption="C.Acceso"
                                Visible="False">
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Reception_seals1"
                                ShowInCustomizationForm="True" VisibleIndex="25" Caption="Sello Proveedor"
                                Visible="False">
                                <EditFormSettings Visible="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Reception_seals2"
                                ShowInCustomizationForm="True" VisibleIndex="26" Caption="Sello Aduana"
                                Visible="False">
                                <EditFormSettings Visible="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Reception_seals3"
                                ShowInCustomizationForm="True" VisibleIndex="27" Caption="Sello SAG"
                                Visible="False">
                                <EditFormSettings Visible="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Reception_NumContainer"
                                ShowInCustomizationForm="True" VisibleIndex="28" Caption="N Contenedor"
                                Visible="False">
                                <EditFormSettings Visible="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Reception_Destination"
                                ShowInCustomizationForm="True" VisibleIndex="31" Visible="False">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Reception_RefrigerationUnit"
                                ShowInCustomizationForm="True" VisibleIndex="32" Visible="False">
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Reception_U_RazonRef"
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="T Recepcion" FieldName="Reception_Type"
                                ...
                                <PropertiesComboBox>
                                    <Items>
                                        ...
                                        <dx:ListEditItem Text="Productiva" Value="2" />
                                        <dx:ListEditItem Text="Ajuste de Entrada" Value="5" />
                                    </Items>
                                </PropertiesComboBox>
                            </dx:GridViewDataComboBoxColumn>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
                    ...
                    <asp:LinqDataSource ID="LqDsTipoDocumento" runat="server"
                        ContextTypeName="DBMermasRecepcion.DBMLCVTWMSDataContext" EntityTypeName=""
                        TableName="DocType"
                        Where="DocType_Id != @DocType_Id &amp;&amp; DocType_Id != @DocType_Id1 &amp;&amp; DocType_Id != @DocType_Id2">
                        <WhereParameters>
                            <asp:Parameter DefaultValue="3" Name="DocType_Id" Type="Int32" />
                            <asp:Parameter DefaultValue="11" Name="DocType_Id1" Type="Int32" />
