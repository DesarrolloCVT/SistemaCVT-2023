<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="EjercicioTrazabilidadPT.aspx.cs" Inherits="CVT_MermasRecepcion.Trazabilidad.EjercicioTrazabilidadPT" %>
...
<div>
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="COD PRODUCTO"></dx:ASPxLabel>
            </td>
            <td>
                <dx:ASPxComboBox ID="cbo_Producto" runat="server" DataSourceID="LqDsProducto" ValueField="ItemCode">
                    <Columns>
                ...
                <asp:LinqDataSource ID="LqDsProducto" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTSAPDataContext" EntityTypeName="" Select="new (ItemCode, ItemName)" TableName="OITM" Where="QryGroup4 == @QryGroup4 &amp;&amp; validFor == @validFor">
                    <WhereParameters>
...
<Image IconID="actions_download_16x16office2013"></Image>
        ...
        <Columns>
            <dx:GridViewDataTextColumn Caption="LotePT" FieldName="Lote" VisibleIndex="0">
            ...
            <dx:GridViewDataTextColumn Caption="Factura" FieldName="Factura" VisibleIndex="3">
            </dx:GridViewDataTextColumn>
...
<Image IconID="actions_download_16x16office2013"></Image>
    ...
    <div>
    <p>CONSUMIBLES<dx:ASPxGridView ID="GV_Consumibles" runat="server" AutoGenerateColumns="False">
        <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="Default" />
<SettingsSearchPanel CustomEditorID="tbToolbarSearch" />
<SettingsPopup>
<FilterControl AutoUpdatePosition="False"></FilterControl>
