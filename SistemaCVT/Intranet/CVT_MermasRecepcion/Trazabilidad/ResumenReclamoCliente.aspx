<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ResumenReclamoCliente.aspx.cs" Inherits="CVT_MermasRecepcion.Trazabilidad.ResumenReclamoCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    ...
    <ul>
        ...
        <li><span id="current">Reclamo CLiente Envasado</span></li>
    </ul>
</div>

<div id="tableHeader">
    <span class="tableTitle">Resumen Reclamo Cliente Envasado</span>
...
<div>
    <p>Datos OF</p>
    <dx:ASPxGridView ID="GV_DatosOF" runat="server" AutoGenerateColumns="False">
...
<Image IconID="actions_download_16x16office2013"></Image>
        ...
        <Columns>
            <dx:GridViewDataTextColumn Caption="N OF" FieldName="DocNum" VisibleIndex="0">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Cantidad Producida" FieldName="U_CantPTReal" VisibleIndex="1">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Silo" FieldName="U_NumSilo" VisibleIndex="2">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Fecha Produccion" FieldName="DueDate" VisibleIndex="3">
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
</div>
<div>
    <p>Lotes Utilizados</p>
    <dx:ASPxGridView ID="GV_DatosMP" runat="server" AutoGenerateColumns="False">
        <SettingsExport EnableClientSideExportAPI="true" ExcelExportMode="Default" />
<SettingsSearchPanel CustomEditorID="tbToolbarSearch" />
<SettingsPopup>
<FilterControl AutoUpdatePosition="False"></FilterControl>
...
<Image IconID="actions_download_16x16office2013"></Image>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Producto" FieldName="Dscription" VisibleIndex="1">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Cantidad Utilizada" FieldName="Quantity" VisibleIndex="2">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Lote MP" FieldName="BatchNum" VisibleIndex="3">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Cantidad del Lote utilizado" FieldName="QuantityLot" VisibleIndex="4">
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
</div>
