<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ControlAsistenciaJBD.aspx.cs" Inherits="CVT_MermasRecepcion.JBD.ControlAsistenciaJBD" %>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
        ...
        <asp:LinqDataSource ID="LqDsAsistencia" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EnableDelete="True" EnableUpdate="True" EntityTypeName="" TableName="CVT_Asistencia_JBD" OrderBy="Fecha desc, Asistencia_Id desc" Where="Fecha == @Fecha">
            <WhereParameters>
