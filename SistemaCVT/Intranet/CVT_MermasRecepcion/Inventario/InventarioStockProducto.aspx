<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="InventarioStockProducto.aspx.cs" Inherits="CVT_MermasRecepcion.Inventario.InventarioStockProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><span id="current">Stock Productos CVT SMM</span></li>
        </ul>
    </div>
    <div id="tableHeader">
        <span class="tableTitle">Stock Productos CVT SMM</span>
    ...
    <div>
        <dx:ASPxPivotGrid ID="PvDatos" runat="server" ClientIDMode="AutoID">
            <Fields>
                ...
                <dx:PivotGridField ID="fieldItemCode" Area="RowArea" AreaIndex="0" Caption="Cod.Producto" FieldName="ItemCode" Name="fieldItemCode">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldItemName" Area="RowArea" AreaIndex="1" Caption="Producto" FieldName="ItemName" Name="fieldItemName">
                </dx:PivotGridField>
