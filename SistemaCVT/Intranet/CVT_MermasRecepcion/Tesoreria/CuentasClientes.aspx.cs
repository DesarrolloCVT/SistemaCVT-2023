    ...
    public partial class CuentasClientes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                GvDatosCuentaClientes.DataBind();
        ...
        protected void GvDatos_ToolbarItemClick(object source, DevExpress.Web.Data.ASPxGridViewToolbarItemClickEventArgs e)
        {
            ...
            {
                GvDatosCuentaClientes.SettingsExport.FileName = "Cuenta Clientes - " + DateTime.Now.ToShortDateString();
            }
        }
       
        protected void GvDatos_CustomSummaryCalculate(object sender, DevExpress.Data.CustomSummaryEventArgs e)
        {
            CountBase = GvDatosCuentaClientes.VisibleRowCount;
