<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="EstadisticaVentasVendedores.aspx.cs" Inherits="CVT_MermasRecepcion.Comercial.EstadisticaVentasComVendedores" %>
...
<Image IconID="actions_download_16x16office2013"></Image>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Prc_Rapel" VisibleIndex="20" Visible="False">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Prec_SinRapel" VisibleIndex="21" Visible="False">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="VendedorDireccion" VisibleIndex="34" Visible="False">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="CobroFianza" VisibleIndex="65" Visible="False">
                    <PropertiesTextEdit DisplayFormatString="N4">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="TCobroFianza" VisibleIndex="66" Visible="False">
                    <PropertiesTextEdit DisplayFormatString="N4">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="TotalRapel" VisibleIndex="67" Visible="False">
                    <PropertiesTextEdit DisplayFormatString="N4">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="TTotalRapel" VisibleIndex="68" Visible="False">
                    <PropertiesTextEdit DisplayFormatString="N4">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="TotalSinRapel" VisibleIndex="69" Visible="False">
                </dx:GridViewDataTextColumn>
