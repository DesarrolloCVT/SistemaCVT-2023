<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AnalisisCompraDetFactura.aspx.cs" Inherits="CVT_MermasRecepcion.Comercial.AnalisisCompraDetFactura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Comercial</a></li>
            <li><span id="current">Analisis Compras Detalle Facturas</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Analisis Compras Detalle Facturas</span>
    ...
    <div>
        <dx:ASPxPivotGrid ID="PvDatos" runat="server" ClientIDMode="AutoID">
            <Fields>
                ...
                <dx:PivotGridField ID="fieldCodGrupoProveedor" FieldName="CodGrupoProveedor" Name="fieldCodGrupoProveedor" Visible="False">
                </dx:PivotGridField>
                ...
                <dx:PivotGridField ID="fieldFolio" Area="RowArea" AreaIndex="3" FieldName="Folio" Name="fieldFolio">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldNReferencia" FieldName="NReferencia" Name="fieldNReferencia" Area="RowArea" AreaIndex="4">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldGrupoProducto" Area="RowArea" AreaIndex="5" FieldName="GrupoProducto" Name="fieldGrupoProducto">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldCodProducto" Area="RowArea" AreaIndex="6" FieldName="CodProducto" Name="fieldCodProducto">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldProducto" Area="RowArea" AreaIndex="7" FieldName="Producto" Name="fieldProducto">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldCantidad" Area="DataArea" AreaIndex="0" FieldName="Cantidad"  CellFormat-FormatString="N0" CellFormat-FormatType="Custom" Name="fieldCantidad">
                </dx:PivotGridField>
                ...
                <dx:PivotGridField ID="fieldPaisOrigen" Area="RowArea" AreaIndex="8" FieldName="PaisOrigen" Name="fieldPaisOrigen">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldIncoterm" Area="RowArea" AreaIndex="9" FieldName="Incoterm" Name="fieldIncoterm">
                </dx:PivotGridField>
            </Fields>
