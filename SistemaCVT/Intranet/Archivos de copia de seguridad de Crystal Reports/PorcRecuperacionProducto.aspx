<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PorcRecuperacionProducto.aspx.cs" Inherits="CVT_MermasRecepcion.ControlCierreMensual.BPT.PorcRecuperacionProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><span id="current">Porcentaje recuperacion de productos</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Porcentaje recuperacion de productos</span>
