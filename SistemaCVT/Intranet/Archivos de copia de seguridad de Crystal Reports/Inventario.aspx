<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Inventario.aspx.cs" Inherits="CVT_MermasRecepcion.Inventario.Inventario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    ...
    <div>
        ...
        <asp:LinqDataSource ID="LqsInventario" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" OrderBy="FechaCreacion desc" TableName="CVT_CabeceraInventario">
        </asp:LinqDataSource>
