<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ComparativoStockProdSinLote.aspx.cs" Inherits="CVT_MermasRecepcion.Inventario.ComparativoStockProdSinLote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><span id="current">Comparativo Stock Productos Sin Lote</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Comparativo Stock Productos Sin Lote</span>
    ...
    <div style="margin-left: 15px">
        ...
        <dx:ASPxPivotGrid ID="PvDatos" runat="server" ClientIDMode="AutoID">
            <Fields>
                ...
                <dx:PivotGridField ID="fieldDif" Area="DataArea" AreaIndex="2" FieldName="Dif" Name="fieldDif" Caption="Diferencia">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldGrupo" Area="RowArea" AreaIndex="0" FieldName="Grupo" Name="fieldGrupo">
                </dx:PivotGridField>
                <dx:PivotGridField ID="fieldCuenta" Area="RowArea" AreaIndex="2" FieldName="Cuenta" Name="fieldCuenta">
                </dx:PivotGridField>
                ...
                <dx:PivotGridField ID="fieldCodCuenta" Area="RowArea" AreaIndex="1" FieldName="CodCuenta" Name="fieldCodCuenta">
                </dx:PivotGridField>
            </Fields>
