<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InspeccionPorotoNegro.aspx.cs" Inherits="CVT_MermasRecepcion.Calidad.Inspecciones.InspeccionPorotoNegro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Calidad</a></li>
            <li><span id="current">Inspeccion Poroto Negro</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Inspeccion Poroto Negro</span>
...
<Image Url="../../Images/pn-add-source-copy.gif"></Image>
            ...
            <Columns>
                ...
                <dx:GridViewDataDateColumn FieldName="Fecha_ingresoRegistro" Visible="False" VisibleIndex="9">
                </dx:GridViewDataDateColumn>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
        ...
        <asp:LinqDataSource ID="LqsPoroto" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" TableName="CVT_InspeccionPT_PorotoNegro" EnableDelete="True" EnableInsert="True" EnableUpdate="True" OrderBy="Id_IspeccionPT_PorotoNegro desc">
        </asp:LinqDataSource>
        ...
        <asp:LinqDataSource ID="LqsProducto" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" TableName="CVT_VW_ProdutoPorotosNegros">
        </asp:LinqDataSource>
    </div>
    <div>
