<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InspeccionPoroto.aspx.cs" Inherits="CVT_MermasRecepcion.Calidad.Inspecciones.InspeccionPorotoHallado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Calidad</a></li>
            <li><span id="current">Inspeccion Porotos</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Inspeccion Porotos</span>
 ...
 <%--           <a>
    ...
    <br />
    <div>
        <dx:ASPxGridView ID="GvDatos" runat="server" AutoGenerateColumns="False" DataSourceID="LqsPoroto" KeyFieldName="Id_IspeccionPT_Poroto" OnRowCommand="GvDatos_RowCommand" OnRowInserting="GvDatos_RowInserting" OnHtmlRowCreated="GvDatos_HtmlRowCreated" OnRowDeleting="GvDatos_RowDeleting" OnRowUpdating="GvDatos_RowUpdating">
...
<Image Url="../../Images/pn-add-source-copy.gif"></Image>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Id_IspeccionPT_Poroto" ReadOnly="True" Visible="False" VisibleIndex="1">
                    <EditFormSettings Visible="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Lote" VisibleIndex="5">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn FieldName="FechaRegistro" VisibleIndex="6">
        ...
        <asp:LinqDataSource ID="LqsPoroto" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" TableName="CVT_InspeccionPT_Porotos" EnableDelete="True" EnableInsert="True" EnableUpdate="True" OrderBy="Id_IspeccionPT_Poroto desc">
        </asp:LinqDataSource>
        ...
        <asp:LinqDataSource ID="LqsProducto" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" TableName="CVT_VW_ProductoPorotos">
        </asp:LinqDataSource>
    </div>
    <div>
