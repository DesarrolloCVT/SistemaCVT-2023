<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FullStockCV200.aspx.cs" Inherits="CVT_MermasRecepcion.Reporteria.FullStockCV200" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    <div id="breadcrumbs">
        <ul>
            ...
            <li><a>Informes</a></li>
            <li><span id="current">Full stock CV201</span></li>
        </ul>
    </div>

    <div id="tableHeader">
        <span class="tableTitle">Full stock CV201</span>
    ...
    <div>
        ...
        <asp:LinqDataSource ID="LqsFullStock" runat="server" ContextTypeName="DBMermasRecepcion.DBMLCVTDESAINTDataContext" EntityTypeName="" TableName="VW_FULLSTOCK_CV200">
        </asp:LinqDataSource>
